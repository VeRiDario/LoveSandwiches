...
def validate_data(values):
    ...
    or if there asen't exactly 6 values.
    """
    print(values)
    try:
...
def calculate_surplus_data(sales_row):
    """
    Comppare sales with stock and calculkate the surplus dor each item type.

    The surplus is defined as the dales figure substracted from the stock:
